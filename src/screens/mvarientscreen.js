...
export default class VarientScreen extends Component {
    ...
    componentDidMount() {
        ...
        const modid = this.props.navigation.getParam('model_id', '');
        this.setState({
            brandId: bid,
            modelId: modid,
        })
        return fetch(Common.BASEURL + 'mvarient.php', {
            method: 'POST',
            headers: {
            ...
            return (
                <View style={styles.container}>
                    <View style={{ height: 55, backgroundColor: COLORS.themeColor, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={StyleCommon.myHeaderText}>Select Variant</Text>
            ...
            return (
                <View style={styles.container}>
                    ...
                    <FlatGrid
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity onPress={this.open.bind(this, item.varient_id.toString())}>
                                <View style={[styles.itemContainer, StyleCommon.shadow]}>
                                    ...
                                    <Text style={styles.itemName}>{item.varient}</Text>
                                </View>
                            </TouchableOpacity>
                        )}
                    />
